...
<br />
##### DuckDuckGo
[Website](https://ddg.gg){:target="_blank" rel="noopener noreferrer"}

This search engine had replaced Google for me a long time before attempting the switch. I can't remember when I first heard of DuckDuckGo, but after I had got use to their [!bangs](https://duckduckgo.com/bang){:target="_blank" rel="noopener noreferrer"} I have not looked back. If I do ever want to use Google Search I will go through [StartPage](https://www.startpage.com/){:target="_blank" rel="noopener noreferrer"}.

<br />
##### Authy
[Website](https://www.authy.com/){:target="_blank" rel="noopener noreferrer"}
...
<br />
##### Protonmail
[Website](https://protonmail.com){:target="_blank" rel="noopener noreferrer"}
...
<br />
##### Firefox
[Website](https://www.mozilla.org/en-US/firefox/new/){:target="_blank" rel="noopener noreferrer"}
...
<br />
##### Waze
[Website](https://www.waze.com){:target="_blank" rel="noopener noreferrer"}
...
One thing Waze doesn't do is pedestrian directions. Prior to moving to Ireland I was living in London so [Citymapper](https://citymapper.com){:target="_blank" rel="noopener noreferrer"} was a life saver. An incredible app with up to date transport information and even a list of routes to take. Very handy when one of the tube lines was busy. Unfortunately Dublin isn't on Citymapper yet, but I'm making do.

<br />
##### Evernote
[Website](https://evernote.com){:target="_blank" rel="noopener noreferrer"}
...
<br />
##### Translator
[Website](http://www.worldlingo.com/){:target="_blank" rel="noopener noreferrer"}
...
<br />
##### Whatsapp
[Website](https://www.whatsapp.com/){:target="_blank" rel="noopener noreferrer"}
...
Another messenging application I use quite a bit is [Telegram](https://telegram.org/){:target="_blank" rel="noopener noreferrer"}. Unfortunately a messenging app is only as useful as the number of people on it. As most people use Whatsapp I have to list that as my primary.

<br />
##### CyanogenMod
[Website](https://web.archive.org/web/20161224194030/https://www.cyanogenmod.org/){:target="_blank" rel="noopener noreferrer"} - archive link as website is now defunct.
...
<br />
##### Youtube
[Website](https://youtube.com){:target="_blank" rel="noopener noreferrer"}

Everybody knows youtube, it's the site with the [piano playing cat](https://youtu.be/kNH_EjHvm3I){:target="_blank" rel="noopener noreferrer"}! This hasn't been left to last on purpose, but it was the most annoying. There isn't really any alternative to Youtube, and the only reason I included it was because since Google took it over you can not create a non-Google account! I was going to create an account with my new email address, but logging into Youtube is logging into Google. I really didn't like that.

As it stands I still use Youtube although I don't log in, which means I find it harder to track my favourite channels. Not the end of the world but it is a bit of a pain in the ass. [Vimeo](https://vimeo.com/){:target="_blank" rel="noopener noreferrer"} has been getting better in terms of content but it's not on par yet.
